...
const translations: Record<Language, Record<string, string>> = {
  sk: {
    ...
    "pergola.color.surcharge": "+20% doplatok",
    "pergola.color.noSurcharge": "v základnej cene",
    "pergola.color.ralOpen": "Otvoriť vzorkovník →",
    "pergola.ral.title": "Vzorkovník RAL",
    "pergola.ral.description": "Vyberte ľubovoľný odtieň zo vzorkovníka RAL Classic. Príplatok 20 % z ceny pergoly platí pre všetky farby na mieru.",
  ...
  en: {
    ...
    "pergola.color.surcharge": "+20% surcharge",
    "pergola.color.noSurcharge": "included in base price",
    "pergola.color.ralOpen": "Open swatch book →",
    "pergola.ral.title": "RAL Color Chart",
    "pergola.ral.description": "Choose any shade from the RAL Classic chart. A 20% surcharge on the pergola price applies to all custom colors.",
  ...
  hu: {
    ...
    "pergola.color.surcharge": "+20% felár",
    "pergola.color.noSurcharge": "alapáron",
    "pergola.color.ralOpen": "Színkártya megnyitása →",
    "pergola.ral.title": "RAL Színskála",
    "pergola.ral.description": "Válasszon bármilyen árnyalatot a RAL Classic színskáláról. Az egyedi színekre 20% felár vonatkozik a pergola árából.",
