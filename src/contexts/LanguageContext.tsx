...
const translations: Record<Language, Record<string, string>> = {
  sk: {
    ...
    "config.benefitDelivery": "Doprava", "config.benefitInstall": "Montáž", "config.benefitInsulation": "Izolácia", "config.benefitFree": "zdarma", "config.benefitIncluded": "v cene", "config.priceNote": "Cena je orientačná. Presná kalkulácia bude v objednávke.",
    ...
    "pergola.color.ral_7016": "RAL 7016 Antracit",
    "pergola.color.ral_9005": "RAL 9005 Čierna",
    "pergola.color.ral_9016": "RAL 9016 Biela",
    "pergola.color.ral_9007": "RAL 9007 Strieborná",
    "pergola.color.ral": "Iná RAL farba",
    "pergola.color.surcharge": "+15% doplatok",
    "pergola.color.noSurcharge": "v základnej cene",
    "pergola.color.ralOpen": "Otvoriť vzorkovník →",
    "sauna.ral.toggle": "Nenašli ste svoju farbu? Zobraziť celú RAL paletu (+{pct} %)",
    "sauna.ral.hide": "Skryť RAL paletu",
    "sauna.ral.search": "Hľadať RAL odtieň (napr. 7016)",
    "sauna.ral.empty": "Žiadny odtieň nenájdený.",
    "sauna.ral.note": "Hex hodnoty sú približné reprodukcie RAL odtieňov na obrazovke, nie záväzná farebná predloha.",
    "pergola.ral.title": "Vzorkovník RAL",
    "pergola.ral.description": "Vyberte ľubovoľný odtieň zo vzorkovníka RAL Classic. Príplatok 15 % z ceny pergoly platí pre všetky farby na mieru.",
    "pergola.ral.searchPlaceholder": "Hľadať: RAL 8017, antracit, modrá…",
    "pergola.ral.empty": "Pre dopyt „{query}“ nič nenájdené.",
    "pergola.ral.selected": "Vybrané:",
    "pergola.ral.noneSelected": "Žiadny RAL odtieň zatiaľ vybraný",
    "pergola.ral.close": "Zavrieť",
    "pergola.ral.clear": "Vymazať",
    ...
    "pergola.led.desc": "35 €/ks. Počet svetiel: šírka(m) − 1, minimálne 5 ks. LED sú integrované v krokvách vrátane zapojenia.",
    "pergola.delivery.title": "Doprava",
    "pergola.delivery.km.label": "Vzdialenosť dopravy (km)",
    "pergola.delivery.km.desc": "0,75 € / km. Zadajte približnú vzdialenosť od nášho skladu k miestu montáže.",
  ...
  en: {
    ...
    "config.benefitDelivery": "Delivery", "config.benefitInstall": "Installation", "config.benefitInsulation": "Insulation", "config.benefitFree": "free", "config.benefitIncluded": "included", "config.priceNote": "Price is indicative incl. VAT. Exact calculation will be in the order.",
    ...
    "pergola.summary.ledUnit": "pcs",
    "pergola.summary.delivery": "Delivery",
    ...
    "pergola.color.ral_7016": "RAL 7016 Anthracite",
    "pergola.color.ral_9005": "RAL 9005 Jet Black",
    "pergola.color.ral_9016": "RAL 9016 Traffic White",
    "pergola.color.ral_9007": "RAL 9007 Grey Aluminium",
    "pergola.color.ral": "Other RAL color",
    "pergola.color.surcharge": "+15% surcharge",
    "pergola.color.noSurcharge": "included in base price",
    "pergola.color.ralOpen": "Open swatch book →",
    "sauna.ral.toggle": "Can\'t find your colour? Show full RAL palette (+{pct}%)",
    "sauna.ral.hide": "Hide RAL palette",
    "sauna.ral.search": "Search RAL shade (e.g. 7016)",
    "sauna.ral.empty": "No shade found.",
    "sauna.ral.note": "Hex values are approximate on-screen reproductions of RAL shades, not a binding colour reference.",
    "pergola.ral.title": "RAL Color Chart",
    "pergola.ral.description": "Choose any shade from the RAL Classic chart. A 15% surcharge on the pergola price applies to all custom colors.",
    "pergola.ral.searchPlaceholder": "Search: RAL 8017, anthracite, blue…",
    "pergola.ral.empty": "Nothing found for \"{query}\".",
    "pergola.ral.selected": "Selected:",
    "pergola.ral.noneSelected": "No RAL shade selected yet",
    "pergola.ral.close": "Close",
    "pergola.ral.clear": "Clear",
    ...
    "pergola.led.desc": "€35 per unit. Number of lights: width(m) − 1, minimum 5. LEDs are integrated into the rafters incl. wiring.",
    "pergola.delivery.title": "Delivery",
    "pergola.delivery.km.label": "Delivery distance (km)",
    "pergola.delivery.km.desc": "€0.75 / km. Enter the approximate distance from our warehouse to the installation site.",
  ...
  hu: {
    ...
    "config.benefitDelivery": "Szállítás", "config.benefitInstall": "Szerelés", "config.benefitInsulation": "Szigetelés", "config.benefitFree": "ingyenes", "config.benefitIncluded": "az árban", "config.priceNote": "Az ár tájékoztató jellegű, áfával együtt. A pontos kalkuláció a megrendelésben lesz.",
    ...
    "pergola.hero.title": "Pergola konfigurátor",
    "pergola.hero.subtitle": "Tervezze meg egyedi pergoláját – lépésről lépésre. Nem kötelező árajánlat percek alatt.",
    "pergola.step.label": "Lépés",
    "pergola.step.1.title": "Méretek",
    "pergola.step.1.subtitle": "Adja meg a pergola méreteit",
    "pergola.step.2.title": "Szín",
    "pergola.step.2.subtitle": "Válassza ki a szerkezet színét",
    "pergola.step.3.title": "Tető",
    "pergola.step.3.subtitle": "Tetőtípus és átlátszóság",
    "pergola.step.4.title": "Felszerelés és kiegészítők",
    "pergola.step.4.subtitle": "Az utolsó részletek finomhangolása",
    "pergola.step.5.title": "Befejezés",
    "pergola.step.5.subtitle": "Tegye kosárba vagy küldjön nem kötelező ajánlatkérést",
    "pergola.nav.back": "Vissza",
    "pergola.nav.continue": "Folytatás",
    "pergola.nav.submit": "Nem kötelező ajánlatkérés küldése",
    "pergola.nav.sending": "Küldés…",
    "pergola.nav.sendShort": "Küldés",
    "pergola.toast.validate": "Kérjük, ellenőrizze a megadott adatokat",
    "pergola.toast.errorTitle": "Küldési hiba",
    "pergola.error.send": "Az ajánlatkérés küldése sikertelen",
    "pergola.mobile.cta": "Nem kötelező ajánlatkérés – egyedi árajánlatot készítünk.",
    "pergola.summary.label": "Az Ön konfigurációja",
    "pergola.summary.title": "Egyedi pergola",
    "pergola.summary.dimensions": "Méretek",
    "pergola.summary.roofArea": "Tetőfelület",
    "pergola.summary.color": "Szín",
    "pergola.summary.roof": "Tető",
    "pergola.summary.transparency": "Átlátszóság",
    "pergola.summary.posts": "Oszlopok",
    "pergola.summary.postUnit": "oszlop",
    "pergola.summary.reinforcement": "merevítés",
    "pergola.summary.mounting": "Felszerelés",
    "pergola.summary.led": "LED világítás",
    "pergola.summary.ledUnit": "db",
    "pergola.summary.delivery": "Szállítás",
    "pergola.summary.yes": "Igen",
    "pergola.summary.no": "Nem",
    "pergola.summary.quote.label": "Árajánlat",
    "pergola.summary.quote.desc": "Az ajánlatkérés elküldése után egyedi, nem kötelező árajánlatot készítünk Önnek.",
    "pergola.color.ral_7016": "RAL 7016 Antracit",
    "pergola.color.ral_9005": "RAL 9005 Fekete",
    "pergola.color.ral_9016": "RAL 9016 Fehér",
    "pergola.color.ral_9007": "RAL 9007 Ezüst",
    "pergola.color.ral": "Egyéb RAL szín",
    "pergola.color.surcharge": "+15% felár",
    "pergola.color.noSurcharge": "alapáron",
    "pergola.color.ralOpen": "Színkártya megnyitása →",
    "sauna.ral.toggle": "Nem találja a színét? Teljes RAL paletta megjelenítése (+{pct}%)",
    "sauna.ral.hide": "RAL paletta elrejtése",
    "sauna.ral.search": "RAL árnyalat keresése (pl. 7016)",
    "sauna.ral.empty": "Nem található árnyalat.",
    "sauna.ral.note": "A hex értékek a RAL árnyalatok közelítő képernyős reprodukciói, nem kötelező érvényű színminták.",
    "pergola.ral.title": "RAL Színskála",
    "pergola.ral.description": "Válasszon bármilyen árnyalatot a RAL Classic színskáláról. Az egyedi színekre 15% felár vonatkozik a pergola árából.",
    "pergola.ral.searchPlaceholder": "Keresés: RAL 8017, antracit, kék…",
    "pergola.ral.empty": "Nincs találat a következőre: „{query}”.",
    "pergola.ral.selected": "Kiválasztva:",
    "pergola.ral.noneSelected": "Még nincs kiválasztva RAL árnyalat",
    "pergola.ral.close": "Bezárás",
    "pergola.ral.clear": "Törlés",
    "pergola.roof.title": "Tetőtípus",
    "pergola.roof.polycarbonate": "Polikarbonát",
    "pergola.roof.polycarbonate.desc": "Könnyű, tartós és megfizethető anyag.",
    "pergola.roof.safety_glass": "Biztonsági üveg",
    "pergola.roof.safety_glass.desc": "Edzett üveg prémium megjelenéssel.",
    "pergola.roof.izo_glass_24": "IZO Üveg 24",
    "pergola.roof.izo_glass_24.desc": "Hőszigetelő kétrétegű üveg – maximális komfort egész évben.",
    "pergola.roof.included": "alapáron",
    "pergola.transparency.title": "Átlátszóság",
    "pergola.transparency.milky": "Tejszínű",
    "pergola.transparency.milky.desc": "Szórt fény, több magánszféra.",
    "pergola.transparency.clear": "Átlátszó",
    "pergola.transparency.clear.desc": "Maximális átlátás és fényáteresztés.",
    "pergola.transparency.izoOnlyClear": "IZO Üveg 24 esetén nem elérhető.",
    "pergola.mounting.title": "Felszerelés",
    "pergola.mounting.no": "Felszerelés nélkül",
    "pergola.mounting.no.desc": "Szállítás és saját kivitelezés.",
    "pergola.mounting.yes": "Felszereléssel",
    "pergola.mounting.yes.desc": "Csapatunk által végzett profi telepítés.",
    "pergola.extras.title": "Kiegészítők",
    "pergola.led.title": "LED világítás",
    "pergola.led.desc": "35 €/db. Lámpák száma: szélesség(m) − 1, minimum 5 db. A LED-ek a szarufákba vannak integrálva, bekötéssel együtt.",
    "pergola.delivery.title": "Szállítás",
    "pergola.delivery.km.label": "Szállítási távolság (km)",
    "pergola.delivery.km.desc": "0,75 € / km. Adja meg a raktárunk és a telepítés helye közötti hozzávetőleges távolságot.",
    "pergola.dim.width": "Szélesség",
    "pergola.dim.depth": "Mélység",
    "pergola.dim.height": "Magasság",
    "pergola.dim.width.rec": "Ajánlott 300–600 cm",
    "pergola.dim.depth.rec": "Ajánlott 300–500 cm",
    "pergola.dim.height.rec": "Ajánlott 240–280 cm",
    "pergola.dim.min": "min",
    "pergola.dim.max": "max",
    "pergola.lead.name": "Teljes név",
    "pergola.lead.phone": "Telefon",
    "pergola.lead.email": "E-mail",
    "pergola.lead.city": "Város",
    "pergola.lead.note": "Megjegyzés",
    "pergola.lead.consentGdpr": "Hozzájárulok személyes adataim kezeléséhez.",
    "pergola.lead.consentTerms": "Elfogadom az általános szerződési feltételeket.",
    "pergola.lead.err.name": "Kérjük, adja meg a nevét",
    "pergola.lead.err.phone": "Kérjük, adjon meg érvényes telefonszámot",
    "pergola.lead.err.email": "Kérjük, adjon meg érvényes e-mail címet",
    "pergola.lead.err.city": "Kérjük, adja meg a várost",
    "pergola.lead.err.consent": "Hozzájárulás szükséges",
    "pergola.success.title": "Köszönjük!",
    "pergola.success.desc": "Megkaptuk az ajánlatkérését. Szakértőnk hamarosan felveszi Önnel a kapcsolatot a nem kötelező árajánlattal.",
    "pergola.preview.width": "Szélesség",
    "pergola.preview.depth": "Mélység",
    "pergola.preview.height": "Magasság",
    "pergola.preview.label": "Előnézet",
  },
};
