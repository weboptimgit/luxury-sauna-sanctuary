...
const translations: Record<Language, Record<string, string>> = {
  sk: {
    ...
    'success.addedToCartDesc': 'Produkt bol úspešne pridaný do košíka.',
    
    // Configurator UI
    'config.hottub.configTitle': 'Konfigurácia kade',
    'config.colorHint': '*Vyberte si farbu povrchovej úpravy sauny.',
    'config.colorNotice': 'Zobrazené fotky farieb sú len ilustračné a nemusia presne zodpovedať finálnemu produktu.',
    'config.priceNote': '* Cena nezahŕňa dopravu a inštaláciu',
    'config.scrollMore': 'Scrolluj pre viac možností',
    'config.selectHeaterModel': 'Vyberte model ohrievača',
    'config.heaterModelRequired': '⚠ Musíte vybrať model ohrievača',
    'config.noLed': 'Bez LED',
    'config.exteriorLed': 'Vonkajšie LED osvetlenie',
    'config.exteriorLedShort': 'Vonkajšie LED',
    'config.without': 'Bez',
    'config.accessoryKitHint': '*Sada obsahuje vedierko s naberačkou, presýpacie hodiny a teplomer.',
    'config.onlyWoodType': 'Tento model je dostupný iba v prevedení {woodType}.',
    'config.lightboxAlt': 'Zväčšený obrázok',
    'tooltip.heater': 'Ohrievač',
    'tooltip.led': 'LED osvetlenie',
  ...
  en: {
    ...
    'success.addedToCartDesc': 'Product has been successfully added to cart.',
    
    // Configurator UI
    'config.hottub.configTitle': 'Hot Tub Configuration',
    'config.colorHint': '*Choose the surface finish color for your sauna.',
    'config.colorNotice': 'Displayed color photos are for illustration purposes only and may not exactly match the final product.',
    'config.priceNote': '* Price does not include delivery and installation',
    'config.scrollMore': 'Scroll for more options',
    'config.selectHeaterModel': 'Select heater model',
    'config.heaterModelRequired': '⚠ You must select a heater model',
    'config.noLed': 'No LED',
    'config.exteriorLed': 'Exterior LED lighting',
    'config.exteriorLedShort': 'Exterior LED',
    'config.without': 'Without',
    'config.accessoryKitHint': '*Set includes bucket with ladle, sand timer and thermometer.',
    'config.onlyWoodType': 'This model is only available in {woodType}.',
    'config.lightboxAlt': 'Enlarged image',
    'tooltip.heater': 'Heater',
    'tooltip.led': 'LED lighting',
    'tooltip.bluetooth': 'Bluetooth',
  },
};
