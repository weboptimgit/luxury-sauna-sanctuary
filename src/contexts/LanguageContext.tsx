...
const translations: Record<Language, Record<string, string>> = {
  sk: {
    ...
    "config.benefitDelivery": "Doprava zdarma", "config.benefitInstall": "Montáž zdarma", "config.benefitInsulation": "Izolácia PU penou zdarma", "config.priceNote": "Cena je orientačná. Presná kalkulácia bude v objednávke.",
  ...
  en: {
    ...
    "config.benefitDelivery": "Free delivery", "config.benefitInstall": "Free installation", "config.benefitInsulation": "Free PU foam insulation", "config.priceNote": "Price is indicative incl. VAT. Exact calculation will be in the order.",
  ...
  hu: {
    ...
    "config.benefitDelivery": "Ingyenes szállítás", "config.benefitInstall": "Ingyenes szerelés", "config.benefitInsulation": "Ingyenes PU hab szigetelés", "config.priceNote": "Az ár tájékoztató jellegű, áfával együtt. A pontos kalkuláció a megrendelésben lesz.",
