...
const translations: Record<Language, Record<string, string>> = {
  sk: {
    ...
    // API option label overrides (heater / led / bluetooth / kit)
    "option.heater.none": "Bez pece",
    "option.heater.electric": "Elektrická pec",
    "option.heater.wood": "Pec na drevo",
    "option.led.none": "Bez LED",
    "option.led.benches": "LED pod lavičkami",
    "option.led.backrest": "LED v operadlách",
    "option.bluetooth.none": "Bez Bluetooth",
    "option.bluetooth.bluetooth": "Bluetooth reproduktor",
    "option.bluetooth.yes": "Bluetooth reproduktor",
    "option.kit.none": "Bez saunovej sady",
    "option.kit.yes": "Saunová sada",
    "option.kit.bluetooth": "Bluetooth reproduktor",
    ...
    "pergola.hero.title": "Konfigurátor pergoly",
    "pergola.hero.subtitle": "Navrhnite si pergolu na mieru – krok za krokom. Nezáväzná cenová ponuka do pár minút.",
    "pergola.step.label": "Krok",
    "pergola.step.1.title": "Rozmery",
    "pergola.step.1.subtitle": "Zadajte rozmery vašej pergoly",
    "pergola.step.2.title": "Farba",
    "pergola.step.2.subtitle": "Vyberte farbu konštrukcie",
    "pergola.step.3.title": "Strecha",
    "pergola.step.3.subtitle": "Typ zastrešenia a priehľadnosť",
    "pergola.step.4.title": "Montáž a doplnky",
    "pergola.step.4.subtitle": "Doladenie posledných detailov",
    "pergola.step.5.title": "Dokončenie",
    "pergola.step.5.subtitle": "Pridajte do košíka alebo pošlite nezáväzný dopyt",
    "pergola.nav.back": "Späť",
    "pergola.nav.continue": "Pokračovať",
    "pergola.nav.submit": "Odoslať nezáväzný dopyt",
    "pergola.nav.sending": "Odosielam…",
    "pergola.nav.sendShort": "Odoslať",
    "pergola.toast.validate": "Skontrolujte zadané údaje",
    "pergola.toast.errorTitle": "Chyba pri odosielaní",
    "pergola.error.send": "Nepodarilo sa odoslať dopyt",
    "pergola.mobile.cta": "Nezáväzný dopyt – cenovú ponuku pripravíme na mieru.",
    "pergola.summary.label": "Vaša konfigurácia",
    "pergola.summary.title": "Pergola na mieru",
    "pergola.summary.dimensions": "Rozmery",
    "pergola.summary.roofArea": "Plocha strechy",
    "pergola.summary.color": "Farba",
    "pergola.summary.roof": "Strecha",
    "pergola.summary.transparency": "Priehľadnosť",
    "pergola.summary.posts": "Stĺpy",
    "pergola.summary.postUnit": "stĺp",
    ...
    "pergola.summary.quote.desc": "Po odoslaní dopytu vám pripravíme nezáväznú cenovú ponuku na mieru.",
    "pergola.color.anthracite": "Antracit",
    "pergola.color.white": "Biela",
    "pergola.color.brown": "Hnedá",
    "pergola.color.golden_oak": "Zlatý dub",
    "pergola.color.walnut": "Orech",
    "pergola.color.ral": "RAL vlastná farba",
    "pergola.color.surcharge": "+10% doplatok",
    "pergola.color.noSurcharge": "bez doplatku",
    "pergola.color.ralOpen": "Otvoriť vzorkovník →",
    "pergola.roof.title": "Typ zastrešenia",
    "pergola.roof.polycarbonate": "Polykarbonát",
    "pergola.roof.polycarbonate.desc": "Ľahký, odolný a cenovo dostupný materiál.",
    "pergola.roof.safety_glass": "Bezpečnostné sklo",
    "pergola.roof.safety_glass.desc": "Kalené sklo s prémiovým vzhľadom.",
    "pergola.roof.izo_glass_24": "IZO Sklo 24",
    "pergola.roof.izo_glass_24.desc": "Izolačné dvojsklo – maximálny komfort celoročne.",
    "pergola.roof.included": "v základe",
    "pergola.transparency.title": "Priehľadnosť",
    "pergola.transparency.milky": "Mliečne",
    "pergola.transparency.milky.desc": "Difúzne svetlo, viac súkromia.",
    "pergola.transparency.clear": "Číre",
    "pergola.transparency.clear.desc": "Maximálny priezor a presvetlenie.",
    "pergola.transparency.izoOnlyClear": "Pri IZO Sklo 24 nie je dostupné.",
    "pergola.mounting.title": "Montáž",
    "pergola.mounting.no": "Bez montáže",
    "pergola.mounting.no.desc": "Doručenie a vlastná montáž.",
    "pergola.mounting.yes": "S montážou",
    "pergola.mounting.yes.desc": "Profesionálna inštalácia naším tímom.",
    "pergola.extras.title": "Doplnky",
    "pergola.led.title": "LED osvetlenie",
    "pergola.led.desc": "Integrované LED pre večernú atmosféru.",
    "pergola.dim.width": "Šírka",
    "pergola.dim.depth": "Hĺbka",
    "pergola.dim.height": "Výška",
    "pergola.dim.width.rec": "Odporúčané 300–600 cm",
    "pergola.dim.depth.rec": "Odporúčané 300–500 cm",
    "pergola.dim.height.rec": "Odporúčané 240–280 cm",
    "pergola.dim.min": "min",
    "pergola.dim.max": "max",
    "pergola.lead.name": "Meno a priezvisko",
    "pergola.lead.phone": "Telefón",
    "pergola.lead.email": "E-mail",
    "pergola.lead.city": "Mesto",
    "pergola.lead.note": "Poznámka",
    "pergola.lead.consentGdpr": "Súhlasím so spracovaním osobných údajov.",
    "pergola.lead.consentTerms": "Súhlasím s obchodnými podmienkami.",
    "pergola.lead.err.name": "Zadajte meno",
    "pergola.lead.err.phone": "Zadajte platné telefónne číslo",
    "pergola.lead.err.email": "Zadajte platný e-mail",
    "pergola.lead.err.city": "Zadajte mesto",
    "pergola.lead.err.consent": "Vyžadovaný súhlas",
    "pergola.success.title": "Ďakujeme!",
    "pergola.success.desc": "Váš dopyt sme prijali. Náš špecialista vás bude čo najskôr kontaktovať s nezáväznou cenovou ponukou.",
    "pergola.preview.width": "Šírka",
    "pergola.preview.depth": "Hĺbka",
    "pergola.preview.height": "Výška",
    "pergola.preview.label": "Náhľad",
  },
  en: {
    // Header
    "nav.home": "Home",
    ...
    // API option label overrides
    "option.heater.none": "No heater",
    "option.heater.electric": "Electric heater",
    "option.heater.wood": "Wood-burning heater",
    "option.led.none": "No LED",
    "option.led.benches": "LED under benches",
    "option.led.backrest": "LED in backrests",
    "option.bluetooth.none": "No Bluetooth",
    "option.bluetooth.bluetooth": "Bluetooth speaker",
    "option.bluetooth.yes": "Bluetooth speaker",
    "option.kit.none": "No sauna kit",
    "option.kit.yes": "Sauna kit",
    "option.kit.bluetooth": "Bluetooth speaker",
    ...
    "pergola.hero.title": "Pergola Configurator",
    "pergola.hero.subtitle": "Design your custom pergola – step by step. A non-binding quote within minutes.",
    "pergola.step.label": "Step",
    "pergola.step.1.title": "Dimensions",
    "pergola.step.1.subtitle": "Enter the dimensions of your pergola",
    "pergola.step.2.title": "Color",
    "pergola.step.2.subtitle": "Choose the frame color",
    "pergola.step.3.title": "Roof",
    "pergola.step.3.subtitle": "Roofing type and transparency",
    "pergola.step.4.title": "Mounting & Extras",
    "pergola.step.4.subtitle": "Fine-tune the final details",
    "pergola.step.5.title": "Finish",
    "pergola.step.5.subtitle": "Add to cart or send a non-binding inquiry",
    "pergola.nav.back": "Back",
    "pergola.nav.continue": "Continue",
    "pergola.nav.submit": "Send non-binding inquiry",
    "pergola.nav.sending": "Sending…",
    "pergola.nav.sendShort": "Send",
    "pergola.toast.validate": "Please check the entered data",
    "pergola.toast.errorTitle": "Submission error",
    "pergola.error.send": "Failed to send the inquiry",
    "pergola.mobile.cta": "Non-binding inquiry – we'll prepare a custom quote.",
    "pergola.summary.label": "Your configuration",
    "pergola.summary.title": "Custom Pergola",
    "pergola.summary.dimensions": "Dimensions",
    "pergola.summary.roofArea": "Roof area",
    "pergola.summary.color": "Color",
    "pergola.summary.roof": "Roof",
    "pergola.summary.transparency": "Transparency",
    "pergola.summary.posts": "Posts",
    "pergola.summary.postUnit": "post",
    "pergola.summary.reinforcement": "reinforcement",
    "pergola.summary.mounting": "Mounting",
    "pergola.summary.led": "LED lighting",
    "pergola.summary.yes": "Yes",
    "pergola.summary.no": "No",
    "pergola.summary.quote.label": "Price quote",
    "pergola.summary.quote.desc": "After submitting, we'll prepare a non-binding custom quote for you.",
    "pergola.color.anthracite": "Anthracite",
    "pergola.color.white": "White",
    "pergola.color.brown": "Brown",
    "pergola.color.golden_oak": "Golden Oak",
    "pergola.color.walnut": "Walnut",
    "pergola.color.ral": "RAL custom color",
    "pergola.color.surcharge": "+10% surcharge",
    "pergola.color.noSurcharge": "no surcharge",
    "pergola.color.ralOpen": "Open swatch book →",
    "pergola.roof.title": "Roofing type",
    "pergola.roof.polycarbonate": "Polycarbonate",
    "pergola.roof.polycarbonate.desc": "Lightweight, durable and affordable material.",
    "pergola.roof.safety_glass": "Safety glass",
    "pergola.roof.safety_glass.desc": "Tempered glass with a premium look.",
    "pergola.roof.izo_glass_24": "IZO Glass 24",
    "pergola.roof.izo_glass_24.desc": "Insulating double-glazing – maximum comfort all year.",
    "pergola.roof.included": "included",
    "pergola.transparency.title": "Transparency",
    "pergola.transparency.milky": "Milky",
    "pergola.transparency.milky.desc": "Diffused light, more privacy.",
    "pergola.transparency.clear": "Clear",
    "pergola.transparency.clear.desc": "Maximum view-through and brightness.",
    "pergola.transparency.izoOnlyClear": "Not available with IZO Glass 24.",
    "pergola.mounting.title": "Mounting",
    "pergola.mounting.no": "Without mounting",
    "pergola.mounting.no.desc": "Delivery and self-installation.",
    "pergola.mounting.yes": "With mounting",
    "pergola.mounting.yes.desc": "Professional installation by our team.",
    "pergola.extras.title": "Extras",
    "pergola.led.title": "LED lighting",
    "pergola.led.desc": "Integrated LEDs for an evening atmosphere.",
    "pergola.dim.width": "Width",
    "pergola.dim.depth": "Depth",
    "pergola.dim.height": "Height",
    "pergola.dim.width.rec": "Recommended 300–600 cm",
    "pergola.dim.depth.rec": "Recommended 300–500 cm",
    "pergola.dim.height.rec": "Recommended 240–280 cm",
    "pergola.dim.min": "min",
    "pergola.dim.max": "max",
    "pergola.lead.name": "Full name",
    "pergola.lead.phone": "Phone",
    "pergola.lead.email": "E-mail",
    "pergola.lead.city": "City",
    "pergola.lead.note": "Note",
    "pergola.lead.consentGdpr": "I agree with the processing of personal data.",
    "pergola.lead.consentTerms": "I agree with the terms and conditions.",
    "pergola.lead.err.name": "Please enter your name",
    "pergola.lead.err.phone": "Please enter a valid phone number",
    "pergola.lead.err.email": "Please enter a valid e-mail",
    "pergola.lead.err.city": "Please enter your city",
    "pergola.lead.err.consent": "Consent required",
    "pergola.success.title": "Thank you!",
    "pergola.success.desc": "We've received your inquiry. Our specialist will contact you as soon as possible with a non-binding quote.",
    "pergola.preview.width": "Width",
    "pergola.preview.depth": "Depth",
    "pergola.preview.height": "Height",
    "pergola.preview.label": "Preview",
  },
  hu: {
    // Header
    "nav.home": "Főoldal",
    ...
    // API option label overrides
    "option.heater.none": "Kályha nélkül",
    "option.heater.electric": "Elektromos kályha",
    "option.heater.wood": "Fatüzelésű kályha",
    "option.led.none": "LED nélkül",
    "option.led.benches": "LED a padok alatt",
    "option.led.backrest": "LED a háttámlákban",
    "option.bluetooth.none": "Bluetooth nélkül",
    "option.bluetooth.bluetooth": "Bluetooth hangszóró",
    "option.bluetooth.yes": "Bluetooth hangszóró",
    "option.kit.none": "Szauna szett nélkül",
    "option.kit.yes": "Szauna szett",
    "option.kit.bluetooth": "Bluetooth hangszóró",
