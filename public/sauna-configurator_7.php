    ...
    'hottub' => [
      ...
      'comboTypes' => [
          'iglu-2in1' => [
              ...
              'woodTypes' => ['spruce', 'thermo'],
              'woodTypePrices' => ['spruce' => 0, 'thermo' => 1500],
              'hasColor' => true,
              'hasWindow' => true,
              'windowOptions' => [
                  'none'  => ['label' => sauna_t('combo.window.none', $lang), 'price' => 0],
                  'round' => ['label' => sauna_t('combo.window.round', $lang), 'price' => 450],
                  'back'  => ['label' => sauna_t('combo.window.back', $lang), 'price' => 600],
              ],
              'hasHeater' => true,
              'heaterOptions' => [
                  'none' => ['label' => sauna_t('hottub.heater.none', $lang), 'price' => 0],
          ...
          'oasis-2in1' => [
              ...
              'windowOptions' => [
                  'none'        => ['label' => sauna_t('combo.window.none', $lang), 'price' => 0],
                  '145x57'      => ['label' => sauna_t('combo.window.145x57', $lang), 'price' => 350],
                  'panoramic50' => ['label' => sauna_t('combo.window.panoramic50', $lang), 'price' => 750],
              ],
              'hasHeater' => true,
              'heaterOptions' => [
                  'none' => ['label' => sauna_t('hottub.heater.none', $lang), 'price' => 0],
